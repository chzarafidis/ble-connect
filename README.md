...
> Άνοιγμα αυτής της σελίδας στο [https://chzarafidis.github.io/ble-connect/](https://chzarafidis.github.io/ble-connect/)
...
* αναζήτηση για **https://github.com/chzarafidis/ble-connect** και εισαγωγή

## Επεξεργασία αυτού του έργου ![Σήμα κατάστασης κατασκευής](https://github.com/chzarafidis/ble-connect/workflows/MakeCode/badge.svg)

Για επεξεργασία αυτού του αποθετηρίου στο MakeCode.

* άνοιγμα [https://makecode.microbit.org/](https://makecode.microbit.org/)
* κάντε κλικ στην **Εισαγωγή** και έπειτα στην **Εισαγωγή διεύθυνσης URL**
* επικολλήστε **https://github.com/chzarafidis/ble-connect** και κάντε κλικ στην εισαγωγή
...
![Προβολή απόδοσης των μπλοκ](https://github.com/chzarafidis/ble-connect/raw/master/.github/makecode/blocks.png)
